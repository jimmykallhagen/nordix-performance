...
##=============================================================================##
 ...
 ###                                                        ###
##                                                            ##
 # * * Nordix commandline collection - CPU Flags: Extreme * * #
##                                                            ##
 ###                                                        ###
   ######***********************************************#####
"
...
CMD_FLAG="rw boot=zfs nowatchdog split_lock_detect=off mitigations=off \
processor.max_cstate=1 intel_idle.max_cstate=1 amd_pstate=active idle=nomwait zswap.enabled=0 transparent_hugepage=madvise \
